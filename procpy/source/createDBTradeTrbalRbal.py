...
dirUse = G_path     
dirLog = dirUse + '\\Log'
fileLog = open(dirLog + '\\createDBTradeTrbalRbal' + G_nomenclature + '.log', 'w')
...
def traitementFichierTXT(nomenclature, fileLog, tableName):
    ...
    if startYearX != startYearM:
        ...
        return
    spiLibCreateTable.createTableTradeTrbalRbal(nomenclature, refDicX, refDicM, startYearM, fileLog, tableName)
