...
fichierCSV      =  dirInput         + '\\naio_cp18_r2.tsv'
fichierP2I      =  dirInput         + '\\naio_cp19_r2.tsv'
fileLog         =  open(dirLog      + '\\matrixMmult.log', 'w')
fileOutput      =  open(dirOutput   + '\\matrixDBMmult.csv', 'w')
...
def readFileP2I(dicMatriceP1Row,dicGeoYearProd):
...
def traitementFichierCSV():
    ...
    dicMatriceP1Row = readFileP2I(dicMatriceP1Row,dicGeoYearProd)    
